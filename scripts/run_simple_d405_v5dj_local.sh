...
CFG=pi05_siemens_simple_d405_v5dj_bs128
EXP=siemens_simple_d405_v5dj_20k_20260903
REPO=siemens_simple_d405_v5dj
...
log() { echo "[v5dj-run $(date -u +%Y-%m-%dT%H:%M:%SZ)] $*"; }
...
log "GPUs free — V5DJ_TRAIN_START $CFG exp=$EXP"
...
log "V5DJ_RUN_DONE rc=$rc wall=$(( (end - start) / 60 ))min"
