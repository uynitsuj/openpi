...
_CONFIGS = [
    ...
    # Public WARP-RM paper simulation serving configs. The training-only
    # reward weighting is already represented in the released parameter trees;
    # inference uses the ordinary YAM observation/action transforms below.
    TrainConfig(
        name="pi0_warp_rm_sim_bottles_vanilla",
        model=pi0_config.Pi0Config(action_horizon=30),
        data=LeRobotYamDataConfig(
    ...
    TrainConfig(
        name="pi0_warp_rm_sim_bottles_rabc_sss15",
        model=pi0_config.Pi0Config(action_horizon=30),
        data=LeRobotYamDataConfig(
